...
⚠️ ของเก่า (2026-08-14): express_sync.py ทำงานนี้ในตัวแล้วและรันเองทุกชั่วโมงจาก run_all.sh
   เก็บไฟล์นี้ไว้เป็นเครื่องมือรันมือสำหรับไล่ยอดเทียบ/ซ่อมเฉพาะแถวที่ import มาจาก ivdata
   งานปกติไม่ต้องเรียกแล้ว
